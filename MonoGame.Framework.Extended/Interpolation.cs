...
namespace MonoGame.Framework.Extended
{
    public static class Interpolation
    {
        ...
        public static Color ValueAt(double time, Color startColor, Color endColor, double startTime, double endTime, EasingTypes easing = EasingTypes.None) {
            ...
            return new Color(
                (byte)ApplyEasing(easing, current, startColor.R, endColor.R - startColor.R, duration).Clamp(0, 255),
                (byte)ApplyEasing(easing, current, startColor.G, endColor.G - startColor.G, duration).Clamp(0, 255),
                (byte)ApplyEasing(easing, current, startColor.B, endColor.B - startColor.B, duration).Clamp(0, 255),
                (byte)ApplyEasing(easing, current, startColor.A, endColor.A - startColor.A, duration).Clamp(0, 255));
        }
